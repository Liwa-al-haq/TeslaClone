    ...
    const handleOrder = async () => {
        ...
        try {
          const res = await axios.put(
            `http://localhost:5000/users/update/order/${currentUser.email}`,
            {
              order: order,
            },
            {
              headers: {
                Authorization: `Bearer ${currentToken}`, // Correctly attach the authorization token
              },
            }
          );
      ...
      return (
        <div className="order">
            <Header/>
            <div className="fixed-white-box"></div>
